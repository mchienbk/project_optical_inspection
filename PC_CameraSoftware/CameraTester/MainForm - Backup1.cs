...
namespace CameraTester
{
    ...
    public partial class MainForm : Form
    {
        ...
        private void btnInspection_Click(object sender, EventArgs e)
        {
            ...
            for (int col = 1; col <= 3; col = col + 1)       //25 coulumn
            {
                ...
                for (int row = 1; row <= 3; row = row + 1)       //10 row
                {
                    ...
                    watch.Stop();
                    WriteResultlData(col, row, watch.ElapsedMilliseconds.ToString());
                    GoY(12);
                    while (!WaitForAData(Timeout));
                }
        ...
        private void Capture_Process(int col, int row)
        {
            ...
            //CvInvoke.CvtColor(_frameCapture, _grayImage, ColorConversion.Bgr2Gray);
            //CvInvoke.PyrDown(_grayImage, _smallGray);
            //CvInvoke.PyrUp(_smallGray, _smoothedGray);
            //CvInvoke.Canny(_smoothedGray, _cannyImage, 100, 60, 3, false);
        ...
        private void WriteResultlData(int col, int row, string dataSave)
        {
...
//---------------------------------------------------------------------------------------------------
        ...
        private void btnManual_Click(object sender, EventArgs e)
        {
            ...
            watch.Stop();
            textBoxOK.Text += String.Format("Matched in {0} milliseconds", watch.ElapsedMilliseconds);
        }
        ...
        public void GetImageMatrixforTest()
        {
            ...
            _objMatrix.GetImageOK(ResultMatrix, CopyImageMatrix_forallImages, ref HKResult);

            textBoxOK.Text = "----" + HKResult + "----";
